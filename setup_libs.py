...
iOS_Lib_Folder = os.path.join('Wwise', 'Wwise_v2013.2.10_build_4884', 'SDK-Apple', 'iOS')
...
Wp8_Lib_Folder = os.path.join('Wwise', 'Wwise_v2013.2.10_build_4884', 'SDK', 'WinPhone_ARM_vc110')
